  ...
  -d "{\\"question\\": \\"а что там по срокам?\\", \\"chat_id\\": \\"$CHAT\\"}"`}</Code>
          ...
          <Section id="limits" title="Ограничения">
            <Fields
              rows={[
                {
                  name: "нет квот на токен",
                  text: "Один ход ограничен по числу вызовов и по времени, поток запросов — нет. Токен это личный ключ: утёкший может тратить деньги в цикле",
                },
                {
